...
export const infoList = [
    { icon: assets.edu_icon, iconDark: assets.edu_icon_dark, title: 'Education', description: 'BSc. in Computer Science,    ' +
            ' MSc. Mechatronics & Al.' },
    { icon: assets.code_icon, iconDark: assets.code_icon_dark, title: 'Languages', description: 'C#, Java' },
    { icon: assets.project_icon, iconDark: assets.project_icon_dark, title: 'Products & Services', description: 'Building scalable business enterprise software' }
];

export const toolsData = [
    assets.vscode, assets.sql, assets.aws, assets.tensorflow, assets.git, assets.github
];